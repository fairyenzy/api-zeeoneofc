...
var creatorList = ['@Misbahul','@mmisbahul898'];
...
loghandler = {
    notparam: {
        ...
        getApikey: 'chat ig @mmisbahul998, apikey gratis'
    },
    notkey: {
        status: false,
        creator: `${creator}`,
    ...
    invalidKey: {
        ...
        creator: `${creator}`,
        code: 406,
        message: 'apikey invalid, gak punya apikey? chat di ig @mmisbahul98 , key nya gratis kok gan'
    },
    invalidlink: {
        status: false,
        creator: `${creator}`,
...
var len = 15
        ...
        var randomTextNumber = random+randomlagi+'---------LilianaBOT'+'mmisbahul998';
...
router.get('/find', async (req, res, next) => {
    ...
    if (apikey != 'mmisbahul998') return res.json(loghandler.invalidKey)
...
router.get('/tiktod', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'mmisbahul998') return res.json(loghandler.invalidKey)
